...
class StartEndDataset(Dataset):
    ...
    def __init__(self, dset_name, data_path, v_feat_dirs, q_feat_dir,
        ...
        print(f'if charadesSTA and use_glove: {self.dset_name == 'charadesSTA'}, and {self.use_glove}')
    ...
    def _load_model_inputs(self, meta):
        ...
        if self.dset_name != 'charadesSTA' and ('qvhighlight' in self.data_path or 'ovis' in self.data_path or 'mot' in self.data_path):
